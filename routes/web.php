...
Route::group(['prefix' => 'users/followers'],function () {
    Route::post('{user}','FollowersController@store')->name('followers.store');
    Route::delete('{user}','FollowersController@destroy')->name('followers.destroy');
});